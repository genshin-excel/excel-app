...
// function TeamDetail({ team, onDelete, onTeamChange }: TeamDetailsProps) {
  ...
  return (
    <Container maxWidth="xl" sx={{ padding: 0 }}>
      <Container maxWidth="xl">
        <Box
          sx={{ display: "flex", justifyContent: "center", margin: "26px 0" }}
        >
          <Grid container>
            <Container maxWidth="xl">
              <Grid container item spacing={2} xs={6}>
                ...
                {/* <Grid container sx={{ marginTop: 1 }}>
                  {lines.map((line, lineIndex) => (
                    <Grid item container xs={12} spacing={2} key={lineIndex} sx={{ marginTop: 1 }}>
                        ...
                        <Grid item xs={6} sm={3} key={id}>
                          <FormControl fullWidth variant="outlined">
                            <Select
                              ...
                              onChange={(event) =>
                                handleSkillChange(event, id, lineIndex)
                              }
                            >
