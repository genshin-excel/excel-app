    ...
    <Grid container rowSpacing={2} display="flex">
      {isSmallScreen && (
        <>
          ...
          <Grid item xs={12} sx={{ position: "sticky", top: 240, zIndex: 100 }}>
          ...
          <Grid item container xs={12} display="flex" justifyContent='flex-end'>
            <Grid item xs={12} sx={{ position: "sticky", top: 320, zIndex: 100 }}>
              <Grid container justifyContent="flex-end">
                <Grid item md={6} sm={4}>
            ...
            <Grid item md={6} sm={4} xs={12} marginTop="16px">
      ...
      {!isSmallScreen && (
        <>
          <Grid container>
            <Grid sx={{
              position: "sticky", top: 50, zIndex: 9999, background: "#fff",
              boxShadow: "0px 2px 4px rgba(0, 0, 0, 0.1)",
            }}>
            ...
            <Grid container sx={{ position: "sticky", top: 0, zIndex: '1' }}>
              <Grid item container xs={12} marginTop="1px">
