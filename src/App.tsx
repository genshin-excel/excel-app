                            ...
                            <Col>
                                <div className="d-flex align-items-center justify-content-center flex-wrap">
                                    ...
                                    <div className="images-container d-flex flex-wrap align-items-center justify-content-center">
                                        ...
                                        <img src="https://via.placeholder.com/150x150" alt="Character 21" className="image mb-3" style={{ width: "150px", height: "150px", marginRight: "5px" }} onClick={() => setSelectedImage(i.toString())} />
                                        <img src="https://via.placeholder.com/150x150" alt="Character 31" className="image mb-3" style={{ width: "150px", height: "150px", marginRight: "5px" }} onClick={() => setSelectedImage(i.toString())} />
                                        <img src="https://via.placeholder.com/150x150" alt="Character 41" className="image mb-3" style={{ width: "150px", height: "150px", marginRight: "5px" }} onClick={() => setSelectedImage(i.toString())} />
                                    </div>
